          ...
          <p><center>
              ...
              <table cellpadding="10" cellspacing="3">
                  <tr>
                    ...
                    <%try{
                      String query="select * from reg where utype='Citizen'";
                  ...
                  <tr>
                      ...
                      <td><a href="Access.jsp?email=<%=rs.getString("email")%>"><font color="red">Give Access</font></a></td>
                      <%}else{%>
                      <td style="background:white"><font color="blue"><%=rs.getString("status")%></font></td>
<%}%>
                  </tr>
                         <%
                     }
