      ...
      <div class="post">
        ...
        <div class="entry">
          <p><center>
			 ...
			 <form name="regform" action="L_Action.jsp" method="post" onSubmit="return validate(this);">
			 <table border="0" >
		    	 <tr><td>User Type</td><td><input type="text" name="utype"  value="Citizen" readonly>
                                     </td>
                    </tr>
							...
							<tr></tr>
                            <tr  align="center"><td><a href="Register.jsp"><h3>New UserRegister</h3></a></td></tr>
