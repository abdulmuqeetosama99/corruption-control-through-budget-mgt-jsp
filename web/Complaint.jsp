   ...
   <div id="content">
	  ...
	  <li><a href="browse.jsp">Browse</a></li>
           ...
           <li><a href="Suggestions.jsp">Suggestions</a></li>
            ...
            <center>
                <form action="C_Action.jsp" method="post">
                <table>
                    <tr><th><U>COMPLAINT HERE</U></th></tr>
                    <tr style="margin-top:50px"><th>User ID</th><td><input type="text" name="uid" value="<%=uid%>" readonly></td></tr>
                    
                    <tr style="margin-top:50px"><th>Complaint ON</th><td><input type="text" name="com" required></td></tr>
                    <tr><th>Write Here</th><td><textarea name="desc" cols="20" rows="10" required></textarea></td></tr>
