      ...
      <div class="post">
        ...
        <div class="entry">
          <p><center>
			 ...
			 <form name="regform" action="./LoginServlet" method="post" onSubmit="return validate(this);">
			 <table border="0" >
                             <tr><td>User Type</td><td><input type="text" name="utype" value="Administrator" readonly></td>
                    </tr>
