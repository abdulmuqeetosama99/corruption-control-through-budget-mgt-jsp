  ...
  <div id="menu">
    <ul>
     <li><a href="index.html">Home</a></li>
      ...
      <li><a href="Login.jsp">Municipal Authorities</a></li>
	  <li><a href="Login.jsp">NGOs</a></li>
...
<table cellspacing=10  style="margin-left:100px;">
<tr>
<td>User Type</td><td><select name="utype">
