	  ...
	  <li><a href="browse.jsp">Browse</a></li>
          <li><a href="Create_Group.jsp">Create Group</a></li>
           ...
           <li><a href="Suggestions.jsp">Suggestions</a></li>
            ...
            <center>
                <form action="F_Action.jsp" method="post">
                <table>
                    <h2><U>WELCOME TO FEEDBACK</U></h2>
                    
                    <tr style="margin-top:50px"><th>User ID</th><td><input type="text" name="uid" value="<%=uid%>" readonly></td></tr>
                    
                    <tr style="margin-top:50px"><th>DEPARTMENT</th><td><input type="text" name="dept" required></td></tr>
                    <tr><th>Write FEEDBACK Here</th><td><textarea name="desc" cols="20" rows="10" required></textarea></td></tr>
