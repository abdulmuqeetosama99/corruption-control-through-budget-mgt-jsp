...
<div id="wrapper" style="background: #000066">
  ...
  <div id="menu">
    ...
    String gnme=(String)session.getAttribute("gname");
    if(gnme.equals("null")){
       session.setAttribute("gname",gname);  
    }else{
    session.setAttribute("gname",gnme);
    }
    %>
   ...
   <div id="content">
	  ...
	  <li><a href="browse.jsp">Browse</a></li>
           ...
           <li><a href="Login.jsp">Logout</a></li>
            ...
            <center>
                                   <h2><U>PLEASE SELECT GROUP MEMBERS</U></h2>
                                   <form action="action.jsp" method="post">
                      <table style="margin-top:40px;">
                    <%
                   try{
                     String query="select * from reg where utype='citizen' and name!='"+uid+"'" ;
                    ...
                    <tr><th><u>User ID:</u></th>
                        <td><input style="border:none;background: none;" type="text" name="uid" value="<%=username%>" readonly>
                            <a style="color:blue;" href="action.jsp?uname=<%=username%>">select</a></td></tr>
