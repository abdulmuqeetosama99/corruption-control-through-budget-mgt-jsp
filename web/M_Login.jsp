      ...
      <div class="post">
        ...
        <div class="entry">
          <p><center>
			 ...
			 <form name="regform" action="M_L_Action.jsp" method="post" onSubmit="return validate(this);">
			 <table border="0" >
                             <tr><td>User Type</td><td><input type="text" name="utype" value="MunicipalAuthority" readonly></td>
                    </tr>
